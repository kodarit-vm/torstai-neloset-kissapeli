...
function luo_lautta() {
  ...
  if (mouseX > taustan_leveys) {
    rect(taustan_leveys - 20, taustan_korkeus -50, lautan_leveys, lautan_korkeus, 30, 30, 10, 10);
  } else {
    rect(mouseX, taustan_korkeus -50, lautan_leveys, lautan_korkeus, 30, 30, 10, 10);
  }
}
